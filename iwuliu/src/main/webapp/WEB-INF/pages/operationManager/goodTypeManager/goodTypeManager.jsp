            ...
            <div class="modal-body">
                ...
                <form id="form-group" class="form-inline">
                    ...
                    <div class="form-group">
                        <label>货物种类描述：</label>
                        <div class="display_inlineBlcok">
                            <input type="text" class="form-control" id="cargoDescs"/>
                            <p></p>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>货物种类中文单位：</label>
                        <div class="display_inlineBlcok">
                            <input type="text" class="form-control" id="cargoC"/>
                            <p></p>
                        </div>
                        <span class="red">*</span>
                    </div>
            ...
            <div class="modal-body addMatch">
                ...
                <form class="form-inline">
                    ...
                    <div class="form-group">
                        <label>货物种类描述:</label>
                        <div class="display_inlineBlcok">
                            <input disabled type="text" class="form-control" id="cargoTypeDesc" />
                            <p></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>货物种类国际单位:</label>
                        <div class="display_inlineBlcok">
                            <input disabled type="text" class="form-control"id="cargoTypeE" />
                            <p></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>货物种类中文单位:</label>
                        <div class="display_inlineBlcok">
                            <input disabled type="text" class="form-control" id="cargoTypeC" />
                            <p></p>
                        </div>
                    </div>
