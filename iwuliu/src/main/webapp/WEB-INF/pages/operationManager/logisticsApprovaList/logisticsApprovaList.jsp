...
<html>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		      	<form  class="form-inline">
					...
					<div class="form-group docubleUneditable formgroupImg">
						<label>行驶证第一页：</label>
	...
	<%--引入自己的css--%>
	<script src="<%=request.getContextPath()%>/static/operationManager/logisticsApprovaList/js/logisticsApprovaList.js"
