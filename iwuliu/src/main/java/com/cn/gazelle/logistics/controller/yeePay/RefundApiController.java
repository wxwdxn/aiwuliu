...
public class RefundApiController {
    Logger logger = Logger.getLogger(RefundApiController.class);

    public String formatStr(String text) {
        return text == null ? "" : text.trim();
    }

    @RequestMapping(value = "submit_refund")
    protected void submit_refund(HttpServletRequest request, HttpServletResponse response,ModelMap model) {
        ...
        try {
            ...
            RequestDispatcher view	= request.getRequestDispatcher("/yeePayManager/home_refundResp");
