/**
 * 版权所有：版权所有(C) 2015
 * 文件名称：SendSmsApiController.java
 * 系统编号: Z0001002
 * 系统名称：物流管理平台
 * 模块编号：
 * 模块名称：
...
public class SendSmsApiController {
    ...
    @RequestMapping(value = "submit_sendsms")
    protected void submit_sendsms(HttpServletRequest request, HttpServletResponse response,ModelMap model) {
        ...
        try {
            ...
            RequestDispatcher view	= request.getRequestDispatcher("/yeePayManager/home_sendSmsResp");
