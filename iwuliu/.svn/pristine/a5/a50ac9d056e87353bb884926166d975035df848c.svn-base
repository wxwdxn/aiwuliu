...
public class DivideApiController {
    ...
    @RequestMapping(value = "submit_divide")
    protected void submit_divide(HttpServletRequest request, HttpServletResponse response,ModelMap model) {
        try {
            //UTF-8编码
            ...
            RequestDispatcher view	= request.getRequestDispatcher("/yeePayManager/home_divideResp");
