...
public class WithdrawApplyServiceImpl implements WithdrawApplyService {
     ...
     */
    public List<T_Data_Withdraw_Apply_Detail> findWithdrawApplyDetail(HashMap<String, String> conditions) {
        List<T_Data_Withdraw_Apply_Detail> applyList = null;
        try {
            applyList = this.withdrawApplyDaoMapper.findWithdrawApplyDetail(conditions);
    ...
    /**
     * 方法名称:indWithdrawApplyDetailOfTruck
     * 方法描述：查询车辆账户提现申请信息
     *
     * @param start_time
     * @param end_time
     * @return List<T_Data_Withdraw_Apply_Detail>
     */
    public List<T_Data_Withdraw_Apply_Detail> findWithdrawApplyDetailOfTruck(String start_time, String end_time,String withdraw_status) {
        List<T_Data_Withdraw_Apply_Detail> applyList = null;
        try {
            applyList = this.withdrawApplyDaoMapper.findWithdrawApplyDetailOfTruck(start_time, end_time,withdraw_status);
